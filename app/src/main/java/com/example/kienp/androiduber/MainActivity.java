package com.example.kienp.androiduber;
...
import com.example.kienp.androiduber.Model.User;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void showRegisterDialog() {
        ...
        dialog.setMessage("Please use email register");
        ...
        dialog.setPositiveButton("REGISTER", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int i) {
                ...
                if (TextUtils.isEmpty(edtPhone.getText().toString())) {
                    Snackbar.make(rootLayout, "Please enter name",
                            Snackbar.LENGTH_SHORT).show();
                    return;
                }
                if (edtPassword.getText().toString().length() < 6) {
                                ...
                                users.child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                                        ...
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                Snackbar.make(rootLayout, "Register successfully !!",
                                                        Snackbar.LENGTH_SHORT).show();
                                            }
                                        })
                                        .addOnFailureListener(new OnFailureListener() {
